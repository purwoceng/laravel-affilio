@extends('core.app')
@section('title', __('Detail Header Funnel Home'))
@section('content')

    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Detail Header Funnel Home</h5>
            </div>
        </div>
    </div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Detail Header Funnel Home</h3>
                    </div>
                            ...
                            <form method="POST" action="{{ route('headerfunnel.update', $data->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Masukkan Url Funnel Link" name="url"
                                        value="{{ $data->header }}" required disabled></input>
                                </div>
                                <div class="form-group">
                                    <label>Deskripsi Funneling<span class="text-danger"></span></label>
                                    <textarea class="form-control" rows="7" placeholder="Masukkan Deskripsi Funnel Link" name="description"
