    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Konten: Markup Harga Produk</h5>
            </div>
        </div>
    </div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Tambah Markup Harga Produk</h3>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('markup_product.store') }}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="input-product-id">Nama Produk</label>
