@extends('core.app')
@section('title', __('Ubah Push Notification'))
@section('content')
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Ubah Push Notification</h3>
                    </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <form method="POST" action="{{ route('pushnotification.update', $data->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Masukkan Title Notification" name="title"
                                        value="{{ $data->title }}"></input>
                                </div>
                                <div class="form-group">
                                    <label>Deskripsi Notification<span class="text-danger">*</span></label>
                                    <textarea class="form-control" rows="4" placeholder="Masukkan Deskripsi Notification" name="description"
                                        value="{{ $data->description }}">{{ $data->description }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>URL Notification<span class="text-danger">*</span></label>
                                    <input class="form-control" placeholder="Masukkan URL Notification" name="url"
                                        value="{{ $data->url }}"></input>
                                </div>
