 ...
 <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
     ...
     <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
         ...
         <ul class="menu-nav">
             ...
             @endhasanyrole
             @hasanyrole('super_user|admin_member')
                 <li class="menu-item menu-item-submenu menu-item-{{ request()->is('carts*') ? 'active' : '' }}"
                     aria-haspopup="true" data-menu-toggle="hover">
                     <a href="{{ route('carts.index') }}" class="menu-link menu-toggle">
                         <span class="svg-icon menu-icon">
                         ...
                         <span class="menu-text">Keranjang Order</span>
                     </a>
                 </li>
             @endhasanyrole
             ...
             @hasanyrole('konten|super_user|admin_member|view')
                 <li class="menu-item menu-item-submenu {{ request()->is('banners*','video_training*','supplierscover*','pushnotification*') ? 'menu-item-open' : '' }}"
                     aria-haspopup="true" data-menu-toggle="hover">
                     <a href="javascript:void(0)" class="menu-link menu-toggle">
                         <span class="svg-icon menu-icon">
                     ...
                     <div class="menu-submenu">
                         ...
                         <li class="menu-item menu-item-submenu menu-item-{{ request()->is('video_training*') ? 'active' : '' }}"
                            aria-haspopup="true" data-menu-toggle="hover">
                             ...
                             <li class="menu-item menu-item-submenu menu-item-{{ request()->is('pushnotification*') ? 'active' : '' }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                 <a href="{{ route('pushnotification.index') }}" class="menu-link">
                                     <i class="menu-bullet menu-bullet-dot">
                                         <span></span>
                                     </i>
