                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm filter" data-name="code"
                                            ...
                                            <option value="BKO">BKO (Bonus Komisi Ongkir)</option>
                                            ...
                                            <option value="BPA">BPA (Bonus Peringkat Affiliator)</option>
                                            <option value="5A">5A (Bonus Super Challenge 5 1)</option>
                                            <option value="5B">5B (Bonus Super Challenge 5 2)</option>
                                            <option value="4A">4A (Bonus Super Challenge 4 1)</option>
                                            <option value="4B">4B (Bonus Super Challenge 4 2)</option>
                                            <option value="3A">3A (Bonus Super Challenge 3 1)</option>
                                            <option value="3B">3B (Bonus Super Challenge 3 2)</option>
                                            <option value="2A">2A (Bonus Super Challenge 2 1)</option>
                                            <option value="2B">2B (Bonus Super Challenge 2 2)</option>
                                            <option value="BA">BA (Bonus Affiliasi)</option>
                                            <option value="1A">1A (Bonus Challange 1A)</option>
                                            <option value="1B">1B (Bonus Challange 1B)</option>
                                            <option value="1C">1C (Bonus Challange 1C)</option>
                                            <option value="1D">1D (Bonus Challange 1D)</option>
                                            <option value="1E">1E (Bonus Challange 1E)</option>
                                            <option value="1F">1F (Bonus Challange 1F)</option>
                                            <option value="1G">1G (Bonus Challange 1G)</option>
                                            <option value="1H">1H (Bonus Challange 1H)</option>
                                            <option value="1I">1I (Bonus Challange 1I)</option>
                                            <option value="1J">1J (Bonus Challange 1J)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12">
