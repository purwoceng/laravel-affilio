@extends('core.app')
@section('title', __('Detail Dana Pensiun'))
@section('content')

    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Detail Dana Pensiun</h5>
            </div>
        </div>
    </div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Detail Dana Pensiun</h3>
                    </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <form method="POST" action="{{ route('notification.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="d-flex flex-row">
                                    <div class="p-1">
                                        <a href="{{ route('pensiun.index') }}" class="btn btn-secondary">Kembali</a>
                                    </div>
                                </div>
                            </form>
                        </div>
