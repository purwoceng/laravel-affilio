@extends('core.app')
@section('title', __('Halaman Invoice Dibatalkan'))
@section('content')
    <!--begin::Subheader-->
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Invoice Dibatalkan</h3>
                    </div>
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            const urlAjax = "{{ route('invoices.cancel.index') }}";

            var tableInvoiceCancel = $('#js-table-invoice-cancel').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                searching: false,
            ...
            function reDrawTable(data) {
                tableInvoiceCancel.ajax.url(getFullUrl(data)).load(null, false);
            };
