@extends('core.app')
@section('title', __('Detail Invoice Belum Dibayar'))
@section('content')

    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Konten: Invoice Belum Dibayar</h5>
            </div>
        </div>
    </div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Detail Invoice Belum Dibayar</h3>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <form method="POST" action="{{ route('invoices.unpaid.show', ['id' => $data->id]) }}"
                                ...
                                <div class="d-flex flex-row">
                                    <div class="p-1">
                                        <a href="{{ route('invoices.unpaid.index') }}"
